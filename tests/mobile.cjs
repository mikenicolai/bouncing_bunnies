...
assert(run("document.querySelector('#buildInfo').textContent.includes('Floating islands and three-heart monsters')"));assert.equal(run('BUILD_INFO.build'),2026091301);assert.equal(run('BUILD_INFO.version'),'0.6.0');assert.equal(run('BUILD_INFO.builtAt'),'2026-09-13T12:08:09+02:00');
